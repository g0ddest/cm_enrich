...
func SaveToPostgres(connStr string, msg *models.EnrichmentMsg) error {
	...
	query := `INSERT INTO communal_outages (
		...
		region_kladr, region_name, region_type, street_kladr, street_name, street_type_full,
	...
	_, err = conn.Exec(context.Background(), query,
		...
		msg.RegionKladr, msg.RegionName, msg.RegionType, msg.StreetKladr, msg.StreetName, msg.StreetTypeFull,
